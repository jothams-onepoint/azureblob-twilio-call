...
const destinationContainer = process.env.DESTINATION_CONTAINER;
const archiveContainer = process.env.ARCHIVE_CONTAINER || sourceContainer;
// Create the BlobServiceClient object which will be used to create a container client
const blobServiceClient = storage_blob_1.BlobServiceClient.fromConnectionString(connectionString);
// Get a reference to a container
exports.containerClient = blobServiceClient.getContainerClient(sourceContainer);
exports.destContainerClient = blobServiceClient.getContainerClient(destinationContainer);
exports.archiveContainerClient = blobServiceClient.getContainerClient(archiveContainer);
...
const archiveBlob = (sourceFile) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!exists) {
        return { "message": `File '${sourceFile}' does not exist in blob '${sourceContainer}'.` };
    }
